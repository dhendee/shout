  ...
  NSInteger errorCode;
    ...
    NSLog(@"[IAP] state: %@", state);
        NSArray *callbackArgs = [NSArray arrayWithObjects:
                                 ...
                                 nil];
    NSString *js = [NSString stringWithFormat:@"window.plugins.inAppPurchaseManager.updatedTransactionCallback.apply(window.plugins.inAppPurchaseManager, %@)", [callbackArgs JSONSerialize]];
    NSLog(@"[IAP] js: %@", js);
...
{
  NSString *js = [NSString stringWithFormat:@"window.plugins.inAppPurchaseManager.onRestoreCompletedTransactionsFailed(%d)", error.code];
    [self.webView stringByEvaluatingJavaScriptFromString:js];
}

- (void)paymentQueueRestoreCompletedTransactionsFinished:(SKPaymentQueue *)queue
{
  NSString *js = @"window.plugins.inAppPurchaseManager.onRestoreCompletedTransactionsFinished()";
    [self.webView stringByEvaluatingJavaScriptFromString:js];
}
